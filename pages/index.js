...
export default function Home() {
  ...
  return (
    <>
      ...
      <h2 className="mt-6 text-2xl text-gray-500 font-poppins font-medium">Fitness Tracking For Workout Enthusiasts 💪</h2>
      <form className="mt-10 border-2 border-gray-800 flex flex-col justify-center rounded-md px-8 py-8 w-full sm:w-2/3 md:w-2/3 lg:w-1/2 xl:w-1/3 2xl:w-1/4">
        <h3 className="text-4xl font-bold mb-3">Log your workout now</h3>
        <h4 className="text-gray-500 font-medium mb-5">{workoutDay}</h4>
        <div className="flex flex-col mb-4">
          ...
          <select value={workoutActivity} onChange={e => setWorkoutActivity(e.target.value)} className="font-poppins rounded-md border-2 border-gray-500 focus:border-gray-800 px-2 py-2 text-xl font-bold">
        ...
        <div className="flex flex-col mb-4">
            ...
            <input id="reps" value={reps} onChange={e => setReps(e.target.value)} type="number" min={1} className="font-poppins border-2 border-gray-500 focus:border-gray-800 rounded-md outline-none px-3 py-2 text-xl font-bold" required />
        </div>
        <div className="flex flex-col mb-4">
            <label htmlFor="sets" className="text-lg font-medium mb-2">Sets:</label>
            <input id="sets" value={sets} onChange={e => setSets(e.target.value)} type="number" min={1} className="font-poppins border-2 border-gray-500 focus:border-gray-800 rounded-md outline-none px-3 py-2 text-xl font-bold" required />
        </div>
        <div className="flex flex-col">
          <label htmlFor="username" className="text-lg font-medium mb-2">Username:</label>
          <input id="username" value={username} onChange={e => setUsername(e.target.value)} type="text" className="font-poppins border-2 border-gray-500 focus:border-gray-800 rounded-md outline-none px-3 py-2 text-xl font-bold" required />
        </div>
        <button type="button" onClick={addNewWorkoutEntry} className="focus:ring ring-offset-2 focus:ring-gray-600 bg-gradient-to-r from-gray-600 to-gray-800 hover:from-gray-800 hover:to-gray-600 transition mt-10 text-xl text-gray-50 rounded-md px-5 py-3 font-bold">Add</button>
      </form>
